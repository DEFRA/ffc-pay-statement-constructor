...
const getNegativeInvoiceLineByFundingCodeAndPaymentRequestId = require('./get-negative-invoice-lines-by-funding-code-and-payment-request-id')
...
const getInvoiceLine = async (fundingCode, paymentRequestId) => {
  ...
  const reductionInvoiceLines = await getNegativeInvoiceLineByFundingCodeAndPaymentRequestId(fundingCode, paymentRequestId)
